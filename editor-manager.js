...
export class EditorManager {
    constructor(containerId, options = {}) {
        ...
        this.onBibleClick = options.onBibleClick || (() => BibleService.showModal());
        this.init();
    }
    ...
    insertHTML(html, atEnd = true) {
        ...
        const index = atEnd ? this.quill.getLength() : (this.quill.getSelection(true)?.index || 0);
